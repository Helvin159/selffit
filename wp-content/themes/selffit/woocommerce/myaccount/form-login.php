...
<div class="u-columns col2-set row m-auto text-center" id="customer_login">
...
<?php endif; ?>
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post">
			...
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
				<label for="username"><?php esc_html_e( 'Nombre de usuario o correo electrónico', 'woocommerce' ); ?>&nbsp;<span class="required">*</span></label>
...
<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
	...
	<div class="u-column2  col-md-6 ">
		<div class="container registerBlock">
			<h2><?php esc_html_e( 'Registrar', 'woocommerce' ); ?></h2>
			...
			<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
				...
				<?php else : ?>
					...
					<p><?php esc_html_e( 'Se le enviará una contraseña a su dirección de correo electrónico..', 'woocommerce' ); ?></p>
				...
				<p class="woocommerce-form-row form-row">
					...
					<button type="submit" class="woocommerce-Button woocommerce-button button woocommerce-form-register__submit" name="register" value="<?php esc_attr_e( 'Registrar', 'woocommerce' ); ?>"><?php esc_html_e( 'Registrar', 'woocommerce' ); ?></button>
				</p>
