...
<section class="woocommerce-customer-details">
	...
	<h2 class="woocommerce-column__title"><?php esc_html_e( 'Dirección de Fractura', 'woocommerce' ); ?></h2>
	...
	<?php if ( $show_shipping ) : ?>
		...
		<div class="woocommerce-column woocommerce-column--2 woocommerce-column--shipping-address col-6">
			<h2 class="woocommerce-column__title"><?php esc_html_e( 'Dirección de Envío', 'woocommerce' ); ?></h2>
			<address>
